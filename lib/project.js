...
function newSubProject(subProjectDir) {
    ...
    logger.info("new subproject at: " + subProjectDir)
...
function parsePath(rootPath, filePath) {
    ...
    if (filePath.includes(rootPath)) {
        let projectRelativePath = filePath.replace(rootPath, "").replace(/^\/*/, "")
        ...
        // logger.info(projectRelativePath)
        ...
        // logger.info("workspace project path match value: " + matchValue)
