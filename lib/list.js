...
function isList(textBlock, rootPath, cursor) {
    ...
    if ((matchValue = fileRE.exec(textBlock[cursor].trim())) != null) {
        // docs/0002_unit_test.md
        console.log("list match file")
        found = true
    } else if ((matchValue = listRE.exec(textBlock[cursor].trim())) != null) {
        ...
        found = true
    } else if ((matchValue = titleWithFileRE.exec(textBlock[cursor].trim())) != null) {
